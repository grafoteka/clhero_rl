...
function in = clheroWalkerResetFcn(in)%,upper_leg_length,lower_leg_length,init_height)
...
%     end       
    ...
    in = in.setVariable('leg_initial_pose', leg_initial_angle);
